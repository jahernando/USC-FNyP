 ...
 * [AB] A. Bettini, *Introduction to Elementary Particle Physics*, Cambridge University Press.

 * [MT] M. Thomson, *Modern Particle Physics*, Cambridge University Press.

 * [BM] B. R. Martin, *Nuclear and Particle Physics: An Introduction*, Wiley.

 * [DP] D. H. Perkins, *Introduction to High Energy Physics*, Cambridge University Press.

 * [AFS] A. Ferrer Soria, *Física Nuclear y de Partículas*, Publicacions de la Universitat de València.

 * [PDG] [Particle Data Group](https://pdg.lbl.gov/), *Review of Particle Physics*.
